...
module "alb_praefect" {
  source = "./alb_praefect"
  sgalb_praefect_name = var.sgalb_praefect_name
  vpc_id = module.vpc.vpc
  sgalb_praefect_tags = var.sgalb_praefect_tags
  sgalb_praefect_type = var.sgalb_praefect_type
  sgalb_praefect_from_port = var.sgalb_praefect_from_port
  sgalb_praefect_to_port = var.sgalb_praefect_to_port
  sgalb_praefect_protocol = var.sgalb_praefect_protocol
  vpc_cidr = var.vpc_cidr
  alb_praefect_name = var.alb_praefect_name
  alb_praefect_tags = var.alb_praefect_tags
  ...
  alb_tg_prafect_name = var.alb_tg_praefect_name
  availability_zone = var.availability_zone
  tg_praefect_port = var.tg_praefect_port
  tg_praefect_protocol = var.tg_praefect_protocol
  praefect_healthy_threshold = var.praefect_healthy_threshold
  praefect_unhealthy_threshold = var.praefect_unhealthy_threshold
  praefect_timeout = var.praefect_timeout
  target_id = module.ec2_praefect.ec2_praefect
}
