...
resource "aws_route" "private_route" {
  ...
  nat_gateway_id         = module.natgw.nat_gateway_ids[count.index]
}*/
...
module "ec2_rails" {
  ...
  availability_zone       = var.availability_zone
  subnet_id               = var.prsubnet_id
  delete_on_termination   = var.delete_on_termination
  ec2_tags                = var.ec2_tags
  #launch_conf_name_rails  = var.launch_conf_name_rails
  rails_ebs_volume_size   = var.rails_ebs_volume_size
}
...
module "ec2_praefect" {
  ...
  praefect_ebs_volume_size         = var.praefect_ebs_volume_size
}
...
module "ec2_gitlay" {
  ...
  gitlay_ebs_volume_size = var.gitlay_ebs_volume_size
}
...
module "nlb_praefect" {
  ...
  target_id                           = module.ec2_rails.ec2
  nlb_tg_prafect_name                 = var.nlb_tg_prafect_name
}
...
module "route_table"{
  ...
  #public_route_tables = aws_route_table.public
  #private_route_tables = aws_route_table.private
  private_subnet_id = module.subnet.prsnet
  public_subnet_id = module.subnet.pusnet
=======
# #vpc
# module "vpc" {
#   source = "./vpc"
